 ...
 * @author ESA10969
 */
public class BrightUtility {
    public static String bright(String sign, File fil, String ext,
        ...
        try {
            ...
            op = new RescaleOp(bright, contrast, null);
